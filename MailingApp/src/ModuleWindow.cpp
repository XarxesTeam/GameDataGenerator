...
// Data
const char *windowClass = "MailingApp";
const char *windowTitle = "Mailing Application";
...
bool ModuleWindow::start()
{
	...
	RegisterClassEx(&wc);
	hwnd = CreateWindow(windowClass, windowTitle, WS_OVERLAPPEDWINDOW, 100, 100, height, width, NULL, NULL, wc.hInstance, NULL);
